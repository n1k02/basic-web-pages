...
if($('.mainslider').length>0){
	$('.mainslider').slick({
		...
		dots: true,
		arrows: true,
		// // необходим slisk-track{allign-items: flex-start (вроде)}
		...
		// rows:1,
		// slidesPerRow:1,
		// //необходим display:block у slick-track
		//vertical:false,
		//verticalSwiping:false,
		// fade:true,
		// //подключение к другому слайдеру (asNavFor:'класс слайдера')
		//asNavFor:'',
		//appendDots:
